...
<html>
	<head>
        ...
        <link rel='stylesheet'        href='../resource/ext-${EXT_VERSION}/classic/theme-${THEME}/resources/theme-${THEME}-all.css' type='text/css'/>
        <script type='text/javascript' src='../resource/ext-${EXT_VERSION}/build/ext-all-debug.js'></script>
        <script type='text/javascript' src='../resource/ext-${EXT_VERSION}/classic/theme-${THEME}/theme-${THEME}-debug.js'></script>
