...
<html>
	<head>
		...
		<link rel='stylesheet' href='../resource/${EXT_VERSION}/resources/css/ext-all-${THEME}.css' type='text/css' />

		<script type='text/javascript' src='../resource/${EXT_VERSION}/ext-all-debug.js'></script>
		<script type='text/javascript' src='../resource/${EXT_VERSION}/ext-theme-${THEME}.js'></script>
