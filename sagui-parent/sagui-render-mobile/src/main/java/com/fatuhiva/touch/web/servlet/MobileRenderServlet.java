 ...
 */
public class MobileRenderServlet extends HttpServlet {

	private static final long serialVersionUID = 1L;

	public MobileRenderServlet() {
		super();
	}
	...
	private void renderHtmlPage(FatuPage page, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		w.write("<script type='text/javascript' src='../resource/touch-2.2.0/sencha-touch-all-debug.js'></script>\n");
		w.write("<link rel='stylesheet' href='../resource/touch-2.2.0/resources/css/sencha-touch.css' type='text/css' />\n");
